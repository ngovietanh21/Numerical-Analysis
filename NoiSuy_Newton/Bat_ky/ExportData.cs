...
namespace Moc_bat_ky
{
    class ExportData
    {
        public static void ExportData2D(double[,] Data)
        {
            ...
            using (StreamWriter Output = new StreamWriter(@"/Users/VietAnh/Projects/NoiSuy_Newton/Bat_ky/File_Output/Saiphan.csv"))
            {
        ...
        {
            using (StreamWriter Output = new StreamWriter(@"/Users/VietAnh/Projects/NoiSuy_Newton/Bat_ky/File_Output/Dathuc.csv"))
            {
                string content = "";
                int n = Data.Length;
