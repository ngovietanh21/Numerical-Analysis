...
namespace Solution
{
	class ExportData
	{
		public static void ExportData2D(double[,] Data)
		{
			...
			using (StreamWriter Output = new StreamWriter(@"/Users/VietAnh/Projects/NoiSuy_TrungTam/File_Output/Saiphan.csv"))
			{
		...
		{
			using (StreamWriter Output = new StreamWriter(@"/Users/VietAnh/Projects/NoiSuy_TrungTam/File_Output/Dathuc.csv"))
			{
				string content = "";
				int n = Data.Length;
